...
#   - 일자 : 2023년 10월 13일
#   - 작성자 : Byun-hee
#   - 내용 : 카페음료를 주문 및 판매하는 콘솔 프로그램

from serviece_kiosk import user_choice, show_menu

# 메뉴와 가격표
# - Dict Type -> 데이터베이스 대체
main_name = {1: "커피(coffe)", 2: "음료(Drink)", 3: "빵(Bakery)"}

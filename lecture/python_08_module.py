...
# 3. 이미 작성된 프로그램(일반적으로 한 파일(.py)을 의미)
...
# ** 모듈 사용 방법
#   - 라이브러리 또는모듈을 사용하기 위해서는 "import" 필요!

# 가정: "requests" 라이브러리 안에는 1k 개의 모듈이 있다고 가정하자!~~

# 1. import
#   ex) import requests
#   -> "requests"라이브러리 전체 호출(1k 개)
#   -> requests.get()

# 2. from ~ import
#   ex) from requests import get
#   -> "requests" 라이브러리 내에서 "get" 모듈만 호출(1k개 중 1개)
#   -> get()

...
#   - 작성자: qudgmlqudgml
#   - 작성일자: 2023.11.08
#   - 라이브러리: requsts, beautifulsoup4, pymongo
#   -프로스세스(비즈니스 로직)
#       1) 수집 가능한 뉴스 카테고리 출력
...
from serviec.serviece_news import get_news

news_category ={    "사회" : "society" ,
    "정치" : "politics" ,
    "경제" : "economic" ,
    "국제" : "foreign" ,
    "문화" : "culture" ,
...
while True:
    ...
    if result.status_code == 200:
        ...
        url_list = doc.select("ul.list_news2 a.link_txt")#자식 태그와 한칸 띄우기
